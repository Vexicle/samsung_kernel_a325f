...
ARCH            ?= arm64
CROSS_COMPILE   ?= $(srctree)/toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-androidkernel-
...
CC		= $(srctree)/toolchain/proton-clang-20210522/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE	?= $(srctree)/toolchain/proton-clang-20210522/bin/aarch64-linux-gnu-
